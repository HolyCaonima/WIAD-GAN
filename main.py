...
flags.DEFINE_integer("g_iter", 5, "iteration times of G per iteration")
flags.DEFINE_integer("d_iter", 1, "iteration times of D per iteration")
flags.DEFINE_float("clip_abs", 0.01, "clip of D")
flags.DEFINE_integer("batch_size", 64, "bathch size")
...
def main():
    ...
    for epoch in range(start_epoch, FLAGS.max_epoch):
        ...
        gan.generate_and_save_images(FLAGS.batch_size, FLAGS.working_directory)
